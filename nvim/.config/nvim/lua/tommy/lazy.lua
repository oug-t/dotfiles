                ...
                handlers = {
                    ...
                    ruby_lsp = function()
                        require('lspconfig').ruby_lsp.setup({
                            init_options = {
                                formatter = 'rubocop',
                                enabledFeatures = { "codeActions", "diagnostics", "documentHighlights", "documentSymbols", "formatting", "hover", "onTypeFormatting", "selectionRanges", "semanticHighlighting" },
                            },
                        })
                    end,
                    tailwindcss = function()
                        require('lspconfig').tailwindcss.setup({
                            ...
                            init_options = { userLanguages = { erb = "html", ruby = "html" } },
                            settings = {
                                tailwindCSS = {
                                    experimental = {
                                        classRegex = { "class:\\s*\"([^\"]*)", "class:\\s*'([^']*)", "~\\s*\"([^\"]*)" },
                                    },
                                },
                            },
                        })
                    ...
                    ocamllsp = function()
                        require('lspconfig').ocamllsp.setup({ cmd = { "ocamllsp" } })
                    end,
                },
            })
